...
require get_template_directory() . '/inc/rest-api/class-rgm-rest-search-route.php';
require get_template_directory() . '/inc/rest-api/class-rgm-rest-county-route.php';
