    ...
    <div class="sidebar__card sidebar__card--letters">
        ...
        if($letters): ?>
            <div class="row">
                ...
                <div class="col col-2">
                    <a href="<?= get_post_type_archive_link('rgm_phrase'); ?>?<?= http_build_query(array('litera' => $letter), null, "&", PHP_QUERY_RFC3986); ?>" class="<?= (isset($_GET['litera']) && $_GET['litera'] == $letter->slug)?'active':''; ?>"><?= mb_strtoupper($letter, "UTF-8"); ?></a>
                </div>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
